...
interface UpdateBudgetDialogProps {
  themes: string[];
  budget: { id: string; targetAmount: number; theme: string };
  onUpdateBudget: (id: string, budget: { targetAmount: number; theme: string }) => void;
}

export function UpdateBudgetDialog({ themes, budget, onUpdateBudget }: UpdateBudgetDialogProps) {
    ...
    <Dialog open={formOpen} onOpenChange={setFormOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>Modify your existing budget limit.</DialogDescription>
        </DialogHeader>
